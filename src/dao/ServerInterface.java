...
/**
 * This class provides an interface to the CS509 server. It provides sample
 * methods to perform HTTP GET and HTTP POSTS
 * 
 * @author blake
 * @version 1.1
 * @since 2016-02-24
...
public class ServerInterface {
	...
	public Flights getFlights(String teamName, String type, String code, String day) {
		URL url;
		HttpURLConnection connection;
		BufferedReader reader;
		String line;
		...
		try {
			 ...
			 * Create an HTTP connection to the server for a GET
			 */
			url = new URL(mUrlBase + QueryFactory.getFlights(teamName, type, code, day));
			connection = (HttpURLConnection) url.openConnection();
			connection.setRequestMethod("GET");
			connection.setRequestProperty("User-Agent", teamName);
	...
	public boolean buyTickets(String teamName,
							  	String xmlReserve) {
		URL url;
		HttpURLConnection connection;
		...
		try {
			...
			String params = QueryFactory.buyTicket(teamName, xmlReserve);
